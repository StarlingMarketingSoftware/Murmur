 ...
 * @returns {any}
 */
export function apply_hardcoded_location_overrides(raw_query, parsed) {
 ...
 */
export function batch_haversine_km(origin_lat, origin_lng, targets) {
 ...
 * @returns {Float64Array}
 */
export function batch_lat_lng_to_world_pixel(coords, world_size) {
 ...
 * @returns {number}
 */
export function distance_point_to_segment_sq(px, py, ax, ay, bx, by) {
 ...
 * @returns {boolean}
 */
export function is_point_near_segments(x, y, segments, threshold_px) {
 ...
 * @returns {Float64Array}
 */
export function lat_lng_to_world_pixel(lat, lng, world_size) {
 ...
 * @returns {string[]}
 */
export function nearest_us_states(state_name, count) {
 ...
 * @returns {Uint32Array}
 */
export function pick_non_overlapping_indices(xy, priority_order, in_locked_order, out_locked_order, in_locked_mask, max_primary_dots, in_locked_share, hard_cap_outside_by_in_locked, min_separation_sq, cell_size) {
 ...
 * @returns {boolean}
 */
export function point_in_ring(px, py, ring) {
 ...
 * @returns {any}
 */
export function score_hits(hits, config) {
 ...
 * @returns {Uint32Array}
 */
export function stable_viewport_sample(coords, ids, min_lat, max_lat, min_lng, max_lng, slots, seed) {
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('rust_scorer_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
