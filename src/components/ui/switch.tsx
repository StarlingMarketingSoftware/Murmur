	...
	return (
		...
		>
			<SwitchPrimitive.Thumb
				...
				className={cn(
					'bg-foreground dark:data-[state=unchecked]:bg-foreground dark:data-[state=checked]:bg-primary-foreground data-[state=checked]:bg-primary-foreground pointer-events-none block size-[14px] rounded-full ring-0 transition-transform data-[state=checked]:translate-x-[calc(100%)] data-[state=unchecked]:translate-x-[1px]'
				)}
			/>
		</SwitchPrimitive.Root>
	);
