...
export default function MapZoomFrame18StreetStickmanFade35Icon(props: React.SVGProps<SVGSVGElement>) {
	return (
		<svg
		...
		>
			...
			<g opacity={0.35} transform="translate(16.08 7.35) scale(1.35)">
