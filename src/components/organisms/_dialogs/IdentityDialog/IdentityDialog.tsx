	...
	return (
		...
		>
			<DialogPortal>
				...
				{/* <div
					className={twMerge(
						'fixed top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%] !z-[100000] mt-[38vh] flex justify-center',
						showCreatePanel && 'hidden'
					)}
				>
					<Button onClick={handleAssignIdentity} variant="primary-light">
						<ArrowDown /> Confirm and Continue
						<ArrowDown />
					</Button>
				</div> */}
