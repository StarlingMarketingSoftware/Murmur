...
export const Navbar = () => {
	...
	// Map + Research pages: navbar should be fully invisible at the top (so the gradient shows behind it),
	// then become visible once the user scrolls.
	const isMapTopTransparent = (isMapPage || isResearchPage) && !scrolled;
