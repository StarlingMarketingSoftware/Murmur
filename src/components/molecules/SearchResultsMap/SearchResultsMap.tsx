...
import { MapSelectionActionCard } from './MapSelectionActionCard';
import { SelectedMarkerResearchPanel } from './SelectedMarkerResearchPanel';
...
export const SearchResultsMap: FC<SearchResultsMapProps> = ({
	...
	return (
		...
		>
			...
			<SelectedMarkerResearchPanel
				handleResearchPanelMouseEnter={handleResearchPanelMouseEnter}
				handleResearchPanelMouseLeave={handleResearchPanelMouseLeave}
				isCoffeeShopsSearch={isCoffeeShopsSearch}
				isLoading={isLoading}
				isMusicVenuesSearch={isMusicVenuesSearch}
				isRestaurantsSearch={isRestaurantsSearch}
				isWeddingPlannersSearch={isWeddingPlannersSearch}
				selectedMarker={selectedMarker}
				selectedMarkerCoords={selectedMarkerCoords}
				selectedMarkerOverlayRef={selectedMarkerOverlayRef}
				setSelectedMarker={setSelectedMarker}
			/>

			<MapEventPopup
				activeEvent={activeEvent}
				eventPopupOverlayRef={eventPopupOverlayRef}
				forwardWheelToMap={forwardWheelToMap}
				hoveredEventId={hoveredEventId}
				isLoading={isLoading}
				isPointerOverEventPopupRef={isPointerOverEventPopupRef}
				renderEventPopupContent={renderEventPopupContent}
				scheduleEventHoverClose={scheduleEventHoverClose}
				setEventHover={setEventHover}
			/>

			<MapSelectionActionCard
				forwardWheelToMap={forwardWheelToMap}
				isLoading={isLoading}
				onAddSelectionToFolder={onAddSelectionToFolder}
				onWriteSelectionMessage={onWriteSelectionMessage}
				selectedContacts={selectedContacts}
				selectionActionsOverlayRef={selectionActionsOverlayRef}
			/>
		</div>
	);
};
