...
const DASHBOARD_CALENDAR_NATIVE_WIDTH_PX = 669.794;
...
const VENUE_CREATE_EVENT_EMPTY_ROW_LABEL_POSITION_CLASS =
	'absolute left-[28px] top-[2px]';
...
function VenueCreateEventMapPanel() {
				...
				<div className="absolute left-1/2 top-[19px] h-[637px] w-[420px] -translate-x-1/2 overflow-hidden rounded-[12px] border-[2px] border-black bg-white">
					{isEventNameActive ? (
						...
						<>
							...
							<label className="absolute inset-x-0 top-0 block h-[53px] cursor-text">
								<span
									className={`${VENUE_CREATE_EVENT_LABEL_CLASS} absolute left-[28px] top-[2px]`}
								>
									Event Name
							...
							<button
								type="button"
								onClick={openWhereField}
								className="absolute inset-x-0 top-[55px] h-[60px] bg-transparent p-0 text-left"
							>
								<span
									className={`${VENUE_CREATE_EVENT_LABEL_CLASS} absolute left-[28px] top-[2px]`}
								>
								...
								{isWhereFilled && (
									<span className="absolute left-[28px] right-[24px] top-[37px] block h-[18px] truncate font-inter text-[15px] font-medium leading-none text-black">
										{eventForm.location.address}
									</span>
								)}
							</button>
							...
							<button
								type="button"
								onClick={openWhoField}
								className="absolute inset-x-0 top-[117px] h-[60px] bg-transparent p-0 text-left"
							>
								<span
									className={`${VENUE_CREATE_EVENT_LABEL_CLASS} ${VENUE_CREATE_EVENT_EMPTY_ROW_LABEL_POSITION_CLASS}`}
								>
									Who
								</span>
							</button>
							...
							<button
								type="button"
								onClick={openWhenField}
								className="absolute inset-x-0 top-[179px] h-[60px] bg-transparent p-0 text-left"
							>
								<span
									className={`${VENUE_CREATE_EVENT_LABEL_CLASS} absolute left-[28px] top-[2px]`}
								>
							...
							<label className="absolute inset-x-0 top-[241px] block h-[60px] cursor-text">
								<span
									className={`${VENUE_CREATE_EVENT_LABEL_CLASS} absolute left-[28px] top-[2px]`}
								>
									Pay
							...
							<button
								type="button"
								onClick={openDetailsField}
								className="absolute inset-x-0 top-[303px] h-[60px] bg-transparent p-0 text-left"
							>
								<span
									className={`${VENUE_CREATE_EVENT_LABEL_CLASS} ${VENUE_CREATE_EVENT_EMPTY_ROW_LABEL_POSITION_CLASS}`}
								>
							...
							<textarea
								...
								onFocus={openDetailsField}
								onChange={(event) => updateEventField('details', event.target.value)}
								className={`${VENUE_CREATE_EVENT_INPUT_CLASS} absolute bottom-[18px] left-[28px] right-[24px] top-[379px] resize-none text-[15px] font-medium leading-[22px]`}
							/>
						</>
					)}
				</div>
