				...
				>
					<div className="relative">
						...
						>
							...
							>
								<svg width="13" height="13" viewBox="0 0 13 13" fill="none" xmlns="http://www.w3.org/2000/svg" className={cn("transition-opacity", selectedRightBoxIcon === 'info' ? "opacity-100" : "opacity-40 group-hover:opacity-100")}>
									<g>
