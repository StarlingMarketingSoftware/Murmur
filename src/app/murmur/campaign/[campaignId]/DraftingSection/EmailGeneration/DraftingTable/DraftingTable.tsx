			...
			>
				...
				>
					{isPending ? (
						...
						children
					) : isDrafts || isSent || isContacts ? (
						<div className="overflow-visible w-full flex flex-col gap-2 items-center py-2">
							{Array.from({ length: isContacts ? 7 : 6 }).map((_, idx) => (
								<div
									key={idx}
									className={
										isContacts
											? 'select-none w-[366px] h-[49px] overflow-hidden rounded-[8px] border-2 border-[#000000] bg-white'
											: 'select-none w-[366px] h-[64px] overflow-hidden rounded-[8px] border-2 border-[#000000] bg-white p-2'
									}
								/>
							))}
						</div>
