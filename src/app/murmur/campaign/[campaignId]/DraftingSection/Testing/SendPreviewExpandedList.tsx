...
export interface SendPreviewExpandedListProps {
	contacts: ContactWithName[];
	onHeaderClick?: () => void;
	// Live send preview data (updated while sending)
	livePreview?: {
		visible?: boolean;
	...
	// Fallback to a drafted email if live preview not available
	fallbackDraft?: {
		contactId: number;
		subject?: string | null;
		message?: string | null;
...
export const SendPreviewExpandedList: FC<SendPreviewExpandedListProps> = ({
	contacts,
	onHeaderClick,
	livePreview,
	fallbackDraft,
	...
	return (
		<div
			...
			role="region"
			aria-label="Expanded send preview"
		>
			{/* Header */}
			<div
				className={cn(
...
export default SendPreviewExpandedList;
