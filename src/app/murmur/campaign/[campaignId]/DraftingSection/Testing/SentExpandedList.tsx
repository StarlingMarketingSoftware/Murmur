...
export const SentExpandedList: FC<SentExpandedListProps> = ({
	...
	return (
		<div
			className="w-[376px] h-[426px] rounded-md border-2 border-black/30 bg-[#CFEBCF] px-2 pb-2 overflow-hidden flex flex-col"
			role="region"
		...
		>
			...
			>
				...
				<div className="ml-auto flex items-center gap-2 text-[11px] text-black/70 font-medium h-full">
					<span>{`${String(sent.length).padStart(2, '0')} sent`}</span>
				</div>
